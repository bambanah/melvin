...
const invariants: Record<string, { contains: string[]; excludes?: string[] }> =
	{
		...
		"transit-group": {
			...
			// travel code, billed at the apportioned rate
		...
		"transport-group-three-participants": {
			// N=3 apportioning: floorToCent(70.2/3) = $23.40/hr,
		...
		"plan-managed-week": {
			contains: [
				...
				"$0.49/km",
				// The group's non-labour travel apportions the
				...
				// through, the Total was $1153.59. The deliberate
